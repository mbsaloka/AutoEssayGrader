				...
				<div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
					...
					<div className="text-center lg:text-left">
						...
						<p className="text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 leading-relaxed text-gray-300">
							Mengoreksi esai kini tak lagi memakan waktu. Grade
							Mind adalah platform bertenaga AI yang merevolusi
							cara Anda menilai tugas-tugas mahasiswa. Mengoreksi
							esai tidak pernah secepat ini. Dengan teknologi OCR
							dan LLM, platform kami menilai jawaban tulisan
							tangan secara otomatis dan akurat. Kurangi beban
